...
function LegalAss() {
  ...
  return (
    <section
      ...
      ref={intServiceRef}
    >
      <div className="flex flex-col gap-10  w-full laptop:justify-between laptop:flex-row ">
        <div className="w-auto  relative ">
          <LazyLoadImage
            effect="blur"
            src="\LuminaSite\Lumina\international.jpg "
            className="rounded-4xl h-auto laptop:w-[420px] laptop:h-[470px] object-cover"
          />
        ...
        <div className="w-auto space-y-5 text-center text-white laptop:w-[500px] laptop:text-left">
          ...
          <div className="flex items-center justify-center flex-row flex-wrap gap-10 laptop:justify-normal">
            <figure className="bg-stone-100/20 p-6 text-sm text-lg text-yellow-500 rounded-xl w-[130px] laptop:p-4 laptop:w-[200px]">
              Property Assets and Protection
            </figure>
            <figure className="bg-stone-100/20 p-6 text-sm text-lg  text-yellow-500 rounded-xl w-[150px] laptop:p-4 laptop:w-[200px]">
              Power of Attornery and Documentation
            </figure>
            <figure className="bg-stone-100/20 p-6 text-sm text-lg  text-yellow-500 rounded-xl w-[140px] laptop:p-4 laptop:w-[200px]">
